...
var
  ...
  mono_exception_from_token : function(image:PMonoImage; token:uint32_t):PMonoException;
  mono_exception_from_name_two_strings : function(image:PMonoImage; name_space:Pchar; name:Pchar; a1:PMonoString; a2:PMonoString):PMonoException;
  mono_exception_from_name_msg : function(image:PMonoImage; name_space:Pchar; name:Pchar; msg:Pchar):PMonoException;
  mono_exception_from_token_two_strings : function(image:PMonoImage; token:uint32_t; a1:PMonoString; a2:PMonoString):PMonoException;
  ...
  mono_get_exception_divide_by_zero : function:PMonoException;
  mono_get_exception_security : function:PMonoException;
  mono_get_exception_arithmetic : function:PMonoException;
  mono_get_exception_overflow : function:PMonoException;
  mono_get_exception_null_reference : function:PMonoException;
  mono_get_exception_execution_engine : function(msg:Pchar):PMonoException;
  mono_get_exception_thread_abort : function:PMonoException;
  mono_get_exception_thread_state : function(msg:Pchar):PMonoException;
  mono_get_exception_thread_interrupted : function:PMonoException;
  mono_get_exception_serialization : function(msg:Pchar):PMonoException;
  mono_get_exception_invalid_cast : function:PMonoException;
  mono_get_exception_invalid_operation : function(msg:Pchar):PMonoException;
  mono_get_exception_index_out_of_range : function:PMonoException;
  mono_get_exception_array_type_mismatch : function:PMonoException;
  mono_get_exception_type_load : function(class_name:PMonoString; assembly_name:Pchar):PMonoException;
  mono_get_exception_missing_method : function(class_name:Pchar; member_name:Pchar):PMonoException;
  mono_get_exception_missing_field : function(class_name:Pchar; member_name:Pchar):PMonoException;
  mono_get_exception_not_implemented : function(msg:Pchar):PMonoException;
  mono_get_exception_not_supported : function(msg:Pchar):PMonoException;
  mono_get_exception_argument_null : function(arg:Pchar):PMonoException;
  mono_get_exception_argument : function(arg:Pchar; msg:Pchar):PMonoException;
  mono_get_exception_argument_out_of_range : function(arg:Pchar):PMonoException;
  mono_get_exception_io : function(msg:Pchar):PMonoException;
  mono_get_exception_file_not_found : function(fname:PMonoString):PMonoException;
  mono_get_exception_file_not_found2 : function(msg:Pchar; fname:PMonoString):PMonoException;
  mono_get_exception_type_initialization : function(type_name:Pchar; inner:PMonoException):PMonoException;
  mono_get_exception_synchronization_lock : function(msg:Pchar):PMonoException;
  mono_get_exception_cannot_unload_appdomain : function(msg:Pchar):PMonoException;
  mono_get_exception_appdomain_unloaded : function:PMonoException;
  mono_get_exception_bad_image_format : function(msg:Pchar):PMonoException;
  mono_get_exception_bad_image_format2 : function(msg:Pchar; fname:PMonoString):PMonoException;
  mono_get_exception_stack_overflow : function:PMonoException;
  mono_get_exception_out_of_memory : function:PMonoException;
  mono_get_exception_field_access : function:PMonoException;
  mono_get_exception_method_access : function:PMonoException;
  mono_get_exception_reflection_type_load : function(types:PMonoArray; exceptions:PMonoArray):PMonoException;
  mono_get_exception_runtime_wrapped : function(wrapped_exception:PMonoObject):PMonoException;
