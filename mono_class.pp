...
var
  mono_class_get : function(image:PMonoImage; type_token:uint32_t):PMonoClass;
  mono_class_get_full : function(image:PMonoImage; type_token:uint32_t; context:PMonoGenericContext):PMonoClass;
  mono_class_init : function(klass:PMonoClass):mono_bool;
  mono_class_vtable : function(domain:PMonoDomain; klass:PMonoClass):PMonoVTable;
  mono_class_from_name : function(image:PMonoImage; name_space:Pchar; name:Pchar):PMonoClass;
  mono_class_from_name_case : function(image:PMonoImage; name_space:Pchar; name:Pchar):PMonoClass;
  mono_class_get_method_from_name_flags : function(klass:PMonoClass; name:Pchar; param_count:longint; flags:longint):PMonoMethod;
  mono_class_from_typeref : function(image:PMonoImage; type_token:uint32_t):PMonoClass;
  mono_class_from_typeref_checked : function(image:PMonoImage; type_token:uint32_t; error:PMonoError):PMonoClass;
  mono_class_from_generic_parameter : function(param:PMonoGenericParam; image:PMonoImage; is_mvar:mono_bool):PMonoClass;
  { MONO_DEPRECATED  }
  mono_class_inflate_generic_type : function(_type:PMonoType; context:PMonoGenericContext):PMonoType;
  mono_class_inflate_generic_method : function(method:PMonoMethod; context:PMonoGenericContext):PMonoMethod;
  mono_get_inflated_method : function(method:PMonoMethod):PMonoMethod;
  mono_field_from_token : function(image:PMonoImage; token:uint32_t; retklass:PPMonoClass; context:PMonoGenericContext):PMonoClassField;
  mono_bounded_array_class_get : function(element_class:PMonoClass; rank:uint32_t; bounded:mono_bool):PMonoClass;
  mono_array_class_get : function(element_class:PMonoClass; rank:uint32_t):PMonoClass;
  mono_ptr_class_get : function(_type:PMonoType):PMonoClass;
  mono_class_get_field : function(klass:PMonoClass; field_token:uint32_t):PMonoClassField;
  mono_class_get_field_from_name : function(klass:PMonoClass; name:Pchar):PMonoClassField;
  mono_class_get_field_token : function(field:PMonoClassField):uint32_t;
  mono_class_get_event_token : function(event:PMonoEvent):uint32_t;
  mono_class_get_property_from_name : function(klass:PMonoClass; name:Pchar):PMonoProperty;
  mono_class_get_property_token : function(prop:PMonoProperty):uint32_t;
  mono_array_element_size : function(ac:PMonoClass):int32_t;
  mono_class_instance_size : function(klass:PMonoClass):int32_t;
  mono_class_array_element_size : function(klass:PMonoClass):int32_t;
  mono_class_data_size : function(klass:PMonoClass):int32_t;
  mono_class_value_size : function(klass:PMonoClass; align:Puint32_t):int32_t;
  mono_class_min_align : function(klass:PMonoClass):int32_t;
  mono_class_from_mono_type : function(_type:PMonoType):PMonoClass;
  mono_class_is_subclass_of : function(klass:PMonoClass; klassc:PMonoClass; check_interfaces:mono_bool):mono_bool;
  mono_class_is_assignable_from : function(klass:PMonoClass; oklass:PMonoClass):mono_bool;
  mono_ldtoken : function(image:PMonoImage; token:uint32_t; retclass:PPMonoClass; context:PMonoGenericContext):pointer;
  mono_type_get_name : function(_type:PMonoType):Pchar;
  mono_type_get_underlying_type : function(_type:PMonoType):PMonoType;
  { MonoClass accessors  }
  mono_class_get_image : function(klass:PMonoClass):PMonoImage;
  mono_class_get_element_class : function(klass:PMonoClass):PMonoClass;
  mono_class_is_valuetype : function(klass:PMonoClass):mono_bool;
  mono_class_is_enum : function(klass:PMonoClass):mono_bool;
  mono_class_enum_basetype : function(klass:PMonoClass):PMonoType;
  mono_class_get_parent : function(klass:PMonoClass):PMonoClass;
  mono_class_get_nesting_type : function(klass:PMonoClass):PMonoClass;
  mono_class_get_rank : function(klass:PMonoClass):longint;
  mono_class_get_flags : function(klass:PMonoClass):uint32_t;
  mono_class_get_name : function(klass:PMonoClass):Pchar;
  mono_class_get_namespace : function(klass:PMonoClass):Pchar;
  mono_class_get_type : function(klass:PMonoClass):PMonoType;
  mono_class_get_type_token : function(klass:PMonoClass):uint32_t;
  mono_class_get_byref_type : function(klass:PMonoClass):PMonoType;
  mono_class_num_fields : function(klass:PMonoClass):longint;
  mono_class_num_methods : function(klass:PMonoClass):longint;
  mono_class_num_properties : function(klass:PMonoClass):longint;
  mono_class_num_events : function(klass:PMonoClass):longint;
  mono_class_get_fields : function(klass:PMonoClass; iter:Ppointer):PMonoClassField;
  mono_class_get_methods : function(klass:PMonoClass; iter:Ppointer):PMonoMethod;
  mono_class_get_properties : function(klass:PMonoClass; iter:Ppointer):PMonoProperty;
  mono_class_get_events : function(klass:PMonoClass; iter:Ppointer):PMonoEvent;
  mono_class_get_interfaces : function(klass:PMonoClass; iter:Ppointer):PMonoClass;
  mono_class_get_nested_types : function(klass:PMonoClass; iter:Ppointer):PMonoClass;
  mono_class_is_delegate : function(klass:PMonoClass):mono_bool;
  mono_class_implements_interface : function(klass:PMonoClass; iface:PMonoClass):mono_bool;
  { MonoClassField accessors  }
  mono_field_get_name : function(field:PMonoClassField):Pchar;
  mono_field_get_type : function(field:PMonoClassField):PMonoType;
  mono_field_get_parent : function(field:PMonoClassField):PMonoClass;
  mono_field_get_flags : function(field:PMonoClassField):uint32_t;
  mono_field_get_offset : function(field:PMonoClassField):uint32_t;
  mono_field_get_data : function(field:PMonoClassField):Pchar;
  { MonoProperty acessors  }
  mono_property_get_name : function(prop:PMonoProperty):Pchar;
  mono_property_get_set_method : function(prop:PMonoProperty):PMonoMethod;
  mono_property_get_get_method : function(prop:PMonoProperty):PMonoMethod;
  mono_property_get_parent : function(prop:PMonoProperty):PMonoClass;
  mono_property_get_flags : function(prop:PMonoProperty):uint32_t;
  { MonoEvent accessors  }
  mono_event_get_name : function(event:PMonoEvent):Pchar;
  mono_event_get_add_method : function(event:PMonoEvent):PMonoMethod;
  mono_event_get_remove_method : function(event:PMonoEvent):PMonoMethod;
  mono_event_get_raise_method : function(event:PMonoEvent):PMonoMethod;
  mono_event_get_parent : function(event:PMonoEvent):PMonoClass;
  mono_event_get_flags : function(event:PMonoEvent):uint32_t;
  mono_class_get_method_from_name : function(klass:PMonoClass; name:Pchar; param_count:longint):PMonoMethod;
  mono_class_name_from_token : function(image:PMonoImage; type_token:uint32_t):Pchar;
  mono_method_can_access_field : function(method:PMonoMethod; field:PMonoClassField):mono_bool;
  mono_method_can_access_method : function(method:PMonoMethod; called:PMonoMethod):mono_bool;
