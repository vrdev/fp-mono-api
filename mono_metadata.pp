...
var
  mono_metadata_init : procedure;
  mono_metadata_decode_row : procedure(t:PMonoTableInfo; idx:longint; res:Puint32_t; res_size:longint);
  mono_metadata_decode_row_col : function(t:PMonoTableInfo; idx:longint; col:dword):uint32_t;
  mono_metadata_compute_size : function(meta:PMonoImage; tableindex:longint; result_bitfield:Puint32_t):longint;
  mono_metadata_locate : function(meta:PMonoImage; table:longint; idx:longint):Pchar;
  mono_metadata_locate_token : function(meta:PMonoImage; token:uint32_t):Pchar;
  mono_metadata_string_heap : function(meta:PMonoImage; table_index:uint32_t):Pchar;
  mono_metadata_blob_heap : function(meta:PMonoImage; table_index:uint32_t):Pchar;
  mono_metadata_user_string : function(meta:PMonoImage; table_index:uint32_t):Pchar;
  mono_metadata_guid_heap : function(meta:PMonoImage; table_index:uint32_t):Pchar;
  mono_metadata_typedef_from_field : function(meta:PMonoImage; table_index:uint32_t):uint32_t;
  mono_metadata_typedef_from_method : function(meta:PMonoImage; table_index:uint32_t):uint32_t;
  mono_metadata_nested_in_typedef : function(meta:PMonoImage; table_index:uint32_t):uint32_t;
  mono_metadata_nesting_typedef : function(meta:PMonoImage; table_index:uint32_t; start_index:uint32_t):uint32_t;
  mono_metadata_interfaces_from_typedef : function(meta:PMonoImage; table_index:uint32_t; count:Pdword):PPMonoClass;
  mono_metadata_events_from_typedef : function(meta:PMonoImage; table_index:uint32_t; end_idx:Pdword):uint32_t;
  mono_metadata_methods_from_event : function(meta:PMonoImage; table_index:uint32_t; pend:Pdword):uint32_t;
  mono_metadata_properties_from_typedef : function(meta:PMonoImage; table_index:uint32_t; pend:Pdword):uint32_t;
  mono_metadata_methods_from_property : function(meta:PMonoImage; table_index:uint32_t; pend:Pdword):uint32_t;
  mono_metadata_packing_from_typedef : function(meta:PMonoImage; table_index:uint32_t; packing:Puint32_t; size:Puint32_t):uint32_t;
  mono_metadata_get_marshal_info : function(meta:PMonoImage; idx:uint32_t; is_field:mono_bool):Pchar;
  mono_metadata_custom_attrs_from_index : function(meta:PMonoImage; cattr_index:uint32_t):uint32_t;
  mono_metadata_parse_marshal_spec : function(image:PMonoImage; ptr:Pchar):PMonoMarshalSpec;
  mono_metadata_free_marshal_spec : procedure(spec:PMonoMarshalSpec);
  mono_metadata_implmap_from_method : function(meta:PMonoImage; method_idx:uint32_t):uint32_t;
  mono_metadata_field_info : procedure(meta:PMonoImage; table_index:uint32_t; offset:Puint32_t; rva:Puint32_t; marshal_spec:PPMonoMarshalSpec);
  mono_metadata_get_constant_index : function(meta:PMonoImage; token:uint32_t; hint:uint32_t):uint32_t;
  {
  * Functions to extract information from the Blobs
  }
  mono_metadata_decode_value : function(ptr:Pchar; rptr:PPchar):uint32_t;
  mono_metadata_decode_signed_value : function(ptr:Pchar; rptr:PPchar):int32_t;
  mono_metadata_decode_blob_size : function(ptr:Pchar; rptr:PPchar):uint32_t;
  mono_metadata_encode_value : procedure(value:uint32_t; bug:Pchar; endbuf:PPchar);
  mono_type_is_byref : function(_type:PMonoType):mono_bool;
  mono_type_get_type : function(_type:PMonoType):longint;
  { For MONO_TYPE_FNPTR  }
  mono_type_get_signature : function(_type:PMonoType):PMonoMethodSignature;
  { For MONO_TYPE_CLASS, VALUETYPE  }
  mono_type_get_class : function(_type:PMonoType):PMonoClass;
  mono_type_get_array_type : function(_type:PMonoType):PMonoArrayType;
  { For MONO_TYPE_PTR  }
  mono_type_get_ptr_type : function(_type:PMonoType):PMonoType;
  mono_type_get_modifiers : function(_type:PMonoType; is_required:Pmono_bool; iter:Ppointer):PMonoClass;
  mono_type_is_struct : function(_type:PMonoType):mono_bool;
  mono_type_is_void : function(_type:PMonoType):mono_bool;
  mono_type_is_pointer : function(_type:PMonoType):mono_bool;
  mono_type_is_reference : function(_type:PMonoType):mono_bool;
  mono_signature_get_return_type : function(sig:PMonoMethodSignature):PMonoType;
  mono_signature_get_params : function(sig:PMonoMethodSignature; iter:Ppointer):PMonoType;
  mono_signature_get_param_count : function(sig:PMonoMethodSignature):uint32_t;
  mono_signature_get_call_conv : function(sig:PMonoMethodSignature):uint32_t;
  mono_signature_vararg_start : function(sig:PMonoMethodSignature):longint;
  mono_signature_is_instance : function(sig:PMonoMethodSignature):mono_bool;
  mono_signature_explicit_this : function(sig:PMonoMethodSignature):mono_bool;
  mono_signature_param_is_out : function(sig:PMonoMethodSignature; param_num:longint):mono_bool;
  mono_metadata_parse_typedef_or_ref : function(m:PMonoImage; ptr:Pchar; rptr:PPchar):uint32_t;
  mono_metadata_parse_custom_mod : function(m:PMonoImage; dest:PMonoCustomMod; ptr:Pchar; rptr:PPchar):longint;
  mono_metadata_parse_array : function(m:PMonoImage; ptr:Pchar; rptr:PPchar):PMonoArrayType;
  mono_metadata_free_array : procedure(parray:PMonoArrayType);
  mono_metadata_parse_type : function(m:PMonoImage; mode:MonoParseTypeMode; opt_attrs:smallint; ptr:Pchar; rptr:PPchar):PMonoType;
  mono_metadata_parse_param : function(m:PMonoImage; ptr:Pchar; rptr:PPchar):PMonoType;
  mono_metadata_parse_ret_type : function(m:PMonoImage; ptr:Pchar; rptr:PPchar):PMonoType;
  mono_metadata_parse_field_type : function(m:PMonoImage; field_flags:smallint; ptr:Pchar; rptr:PPchar):PMonoType;
  mono_type_create_from_typespec : function(image:PMonoImage; type_spec:uint32_t):PMonoType;
  mono_metadata_free_type : procedure(_type:PMonoType);
  mono_type_size : function(_type:PMonoType; alignment:Plongint):longint;
  mono_type_stack_size : function(_type:PMonoType; alignment:Plongint):longint;
  mono_type_generic_inst_is_valuetype : function(_type:PMonoType):mono_bool;
  mono_metadata_generic_class_is_valuetype : function(gclass:PMonoGenericClass):mono_bool;
  mono_metadata_generic_class_hash : function(gclass:PMonoGenericClass):dword;
  mono_metadata_generic_class_equal : function(g1:PMonoGenericClass; g2:PMonoGenericClass):mono_bool;
  mono_metadata_type_hash : function(t1:PMonoType):dword;
  mono_metadata_type_equal : function(t1:PMonoType; t2:PMonoType):mono_bool;
  mono_metadata_signature_alloc : function(image:PMonoImage; nparams:uint32_t):PMonoMethodSignature;
  mono_metadata_signature_dup : function(sig:PMonoMethodSignature):PMonoMethodSignature;
  mono_metadata_parse_signature : function(image:PMonoImage; token:uint32_t):PMonoMethodSignature;
  mono_metadata_parse_method_signature : function(m:PMonoImage; def:longint; ptr:Pchar; rptr:PPchar):PMonoMethodSignature;
  mono_metadata_free_method_signature : procedure(method:PMonoMethodSignature);
  mono_metadata_signature_equal : function(sig1:PMonoMethodSignature; sig2:PMonoMethodSignature):mono_bool;
  mono_signature_hash : function(sig:PMonoMethodSignature):dword;
  mono_metadata_parse_mh : function(m:PMonoImage; ptr:Pchar):PMonoMethodHeader;
  mono_metadata_free_mh : procedure(mh:PMonoMethodHeader);
  mono_method_header_get_code : function(header:PMonoMethodHeader; code_size:Puint32_t; max_stack:Puint32_t):Pbyte;
  mono_method_header_get_locals : function(header:PMonoMethodHeader; num_locals:Puint32_t; init_locals:Pmono_bool):PPMonoType;
  mono_method_header_get_num_clauses : function(header:PMonoMethodHeader):longint;
  mono_method_header_get_clauses : function(header:PMonoMethodHeader; method:PMonoMethod; iter:Ppointer; clause:PMonoExceptionClause):longint;
  mono_type_to_unmanaged : function(_type:PMonoType; mspec:PMonoMarshalSpec; as_field:mono_bool; unicode:mono_bool; conv:PMonoMarshalConv):uint32_t;
  mono_metadata_token_from_dor : function(dor_index:uint32_t):uint32_t;
  mono_guid_to_string : function(guid:Puint8_t):Pchar;
  mono_guid_to_string_minimal : function(guid:Puint8_t):Pchar;
  mono_metadata_declsec_from_index : function(meta:PMonoImage; idx:uint32_t):uint32_t;
  mono_metadata_translate_token_index : function(image:PMonoImage; table:longint; idx:uint32_t):uint32_t;
  mono_metadata_decode_table_row : procedure(image:PMonoImage; table:longint; idx:longint; res:Puint32_t; res_size:longint);
  mono_metadata_decode_table_row_col : function(image:PMonoImage; table:longint; idx:longint; col:dword):uint32_t;
