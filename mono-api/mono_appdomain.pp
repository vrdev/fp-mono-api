...
var
  mono_init : function(filename:Pchar):PMonoDomain;cdecl;
  mono_init_from_assembly : function(domain_name:Pchar; filename:Pchar):PMonoDomain;cdecl;
  mono_init_version : function(domain_name:Pchar; version:Pchar):PMonoDomain;cdecl;
  mono_get_root_domain : function:PMonoDomain;cdecl;
  mono_runtime_init : procedure(domain:PMonoDomain; start_cb:MonoThreadStartCB; attach_cb:MonoThreadAttachCB);cdecl;
  mono_runtime_cleanup : procedure(domain:PMonoDomain);cdecl;
  mono_install_runtime_cleanup : procedure(func:MonoDomainFunc);cdecl;
  mono_runtime_quit : procedure;cdecl;
  mono_runtime_set_shutting_down : procedure;cdecl;
  mono_runtime_is_shutting_down : function:mono_bool;cdecl;
  mono_check_corlib_version : function:Pchar;cdecl;
  mono_domain_create : function:PMonoDomain;cdecl;
  mono_domain_create_appdomain : function(friendly_name:Pchar; configuration_file:Pchar):PMonoDomain;cdecl;
  mono_domain_set_config : procedure(domain:PMonoDomain; base_dir:Pchar; config_file_name:Pchar);cdecl;
  mono_domain_get : function:PMonoDomain;cdecl;
  mono_domain_get_by_id : function(domainid:int32_t):PMonoDomain;cdecl;
  mono_domain_get_id : function(domain:PMonoDomain):int32_t;cdecl;
  mono_domain_get_friendly_name : function(domain:PMonoDomain):Pchar;cdecl;
  mono_domain_set : function(domain:PMonoDomain; force:mono_bool):mono_bool;cdecl;
  mono_domain_set_internal : procedure(domain:PMonoDomain);cdecl;
  mono_domain_unload : procedure(domain:PMonoDomain);cdecl;
  mono_domain_try_unload : procedure(domain:PMonoDomain; exc:PPMonoObject);cdecl;
  mono_domain_is_unloading : function(domain:PMonoDomain):mono_bool;cdecl;
  mono_domain_from_appdomain : function(appdomain:PMonoAppDomain):PMonoDomain;cdecl;
  mono_domain_foreach : procedure(func:MonoDomainFunc; user_data:pointer);cdecl;
  mono_domain_assembly_open : function(domain:PMonoDomain; name:Pchar):PMonoAssembly;cdecl;
  mono_domain_finalize : function(domain:PMonoDomain; timeout:uint32_t):mono_bool;cdecl;
  mono_domain_free : procedure(domain:PMonoDomain; force:mono_bool);cdecl;
  mono_domain_has_type_resolve : function(domain:PMonoDomain):mono_bool;cdecl;
  mono_domain_try_type_resolve : function(domain:PMonoDomain; name:Pchar; tb:PMonoObject):PMonoReflectionAssembly;cdecl;
  mono_domain_owns_vtable_slot : function(domain:PMonoDomain; vtable_slot:pointer):mono_bool;cdecl;
  mono_context_init : procedure(domain:PMonoDomain);cdecl;
  mono_context_set : procedure(new_context:PMonoAppContext);cdecl;
  mono_context_get : function:PMonoAppContext;cdecl;
  mono_context_get_id : function(context:PMonoAppContext):int32_t;cdecl;
  mono_context_get_domain_id : function(context:PMonoAppContext):int32_t;cdecl;
  mono_jit_info_table_find : function(domain:PMonoDomain; addr:Pchar):PMonoJitInfo;cdecl;
  { MonoJitInfo accessors  }
  mono_jit_info_get_code_start : function(ji:PMonoJitInfo):pointer;cdecl;
  mono_jit_info_get_code_size : function(ji:PMonoJitInfo):longint;cdecl;
  mono_jit_info_get_method : function(ji:PMonoJitInfo):PMonoMethod;cdecl;
  mono_get_corlib : function:PMonoImage;cdecl;
  mono_get_object_class : function:PMonoClass;cdecl;
  mono_get_byte_class : function:PMonoClass;cdecl;
  mono_get_void_class : function:PMonoClass;cdecl;
  mono_get_boolean_class : function:PMonoClass;cdecl;
  mono_get_sbyte_class : function:PMonoClass;cdecl;
  mono_get_int16_class : function:PMonoClass;cdecl;
  mono_get_uint16_class : function:PMonoClass;cdecl;
  mono_get_int32_class : function:PMonoClass;cdecl;
  mono_get_uint32_class : function:PMonoClass;cdecl;
  mono_get_intptr_class : function:PMonoClass;cdecl;
  mono_get_uintptr_class : function:PMonoClass;cdecl;
  mono_get_int64_class : function:PMonoClass;cdecl;
  mono_get_uint64_class : function:PMonoClass;cdecl;
  mono_get_single_class : function:PMonoClass;cdecl;
  mono_get_double_class : function:PMonoClass;cdecl;
  mono_get_char_class : function:PMonoClass;cdecl;
  mono_get_string_class : function:PMonoClass;cdecl;
  mono_get_enum_class : function:PMonoClass;cdecl;
  mono_get_array_class : function:PMonoClass;cdecl;
  mono_get_thread_class : function:PMonoClass;cdecl;
  mono_get_exception_class : function:PMonoClass;cdecl;
  mono_security_enable_core_clr : procedure;cdecl;

type
  MonoCoreClrPlatformCB = function (image_name:Pchar):mono_bool;cdecl;
  
var
  mono_security_set_core_clr_platform_callback : procedure(callback:MonoCoreClrPlatformCB);cdecl;
