...
var
  mono_reflection_parse_type : function(name:Pchar; info:PMonoTypeNameParse):longint;cdecl;
  mono_reflection_get_type : function(image:PMonoImage; info:PMonoTypeNameParse; ignorecase:mono_bool; type_resolve:Pmono_bool):PMonoType;cdecl;
  mono_reflection_free_type_info : procedure(info:PMonoTypeNameParse);cdecl;
  mono_reflection_type_from_name : function(name:Pchar; image:PMonoImage):PMonoType;cdecl;
  mono_reflection_get_token : function(obj:PMonoObject):uint32_t;cdecl;
  mono_assembly_get_object : function(domain:PMonoDomain; assembly:PMonoAssembly):PMonoReflectionAssembly;cdecl;
  mono_module_get_object : function(domain:PMonoDomain; image:PMonoImage):PMonoReflectionModule;cdecl;
  mono_module_file_get_object : function(domain:PMonoDomain; image:PMonoImage; table_index:longint):PMonoReflectionModule;cdecl;
  mono_type_get_object : function(domain:PMonoDomain; _type:PMonoType):PMonoReflectionType;cdecl;
  mono_method_get_object : function(domain:PMonoDomain; method:PMonoMethod; refclass:PMonoClass):PMonoReflectionMethod;cdecl;
  mono_field_get_object : function(domain:PMonoDomain; klass:PMonoClass; field:PMonoClassField):PMonoReflectionField;cdecl;
  mono_property_get_object : function(domain:PMonoDomain; klass:PMonoClass; _property:PMonoProperty):PMonoReflectionProperty;cdecl;
  mono_event_get_object : function(domain:PMonoDomain; klass:PMonoClass; event:PMonoEvent):PMonoReflectionEvent;cdecl;
  { note: this one is slightly different: we keep the whole array of params in the cache  }
  mono_param_get_objects : function(domain:PMonoDomain; method:PMonoMethod):PMonoArray;cdecl;
  mono_method_body_get_object : function(domain:PMonoDomain; method:PMonoMethod):PMonoReflectionMethodBody;cdecl;
  mono_get_dbnull_object : function(domain:PMonoDomain):PMonoObject;cdecl;
  mono_reflection_get_custom_attrs_by_type : function(obj:PMonoObject; attr_klass:PMonoClass; error:PMonoError):PMonoArray;cdecl;
  mono_reflection_get_custom_attrs : function(obj:PMonoObject):PMonoArray;cdecl;
  mono_reflection_get_custom_attrs_data : function(obj:PMonoObject):PMonoArray;cdecl;
  mono_reflection_get_custom_attrs_blob : function(assembly:PMonoReflectionAssembly; ctor:PMonoObject; ctorArgs:PMonoArray; properties:PMonoArray; porpValues:PMonoArray;
    fields:PMonoArray; fieldValues:PMonoArray):PMonoArray;cdecl;
  mono_reflection_get_custom_attrs_info : function(obj:PMonoObject):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_construct : function(cinfo:PMonoCustomAttrInfo):PMonoArray;cdecl;
  mono_custom_attrs_from_index : function(image:PMonoImage; idx:uint32_t):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_method : function(method:PMonoMethod):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_class : function(klass:PMonoClass):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_assembly : function(assembly:PMonoAssembly):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_property : function(klass:PMonoClass; _property:PMonoProperty):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_event : function(klass:PMonoClass; event:PMonoEvent):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_field : function(klass:PMonoClass; field:PMonoClassField):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_from_param : function(method:PMonoMethod; param:uint32_t):PMonoCustomAttrInfo;cdecl;
  mono_custom_attrs_has_attr : function(ainfo:PMonoCustomAttrInfo; attr_klass:PMonoClass):mono_bool;cdecl;
  mono_custom_attrs_get_attr : function(ainfo:PMonoCustomAttrInfo; attr_klass:PMonoClass):PMonoObject;cdecl;
  mono_custom_attrs_free : procedure(ainfo:PMonoCustomAttrInfo);cdecl;
  mono_declsec_flags_from_method : function(method:PMonoMethod):uint32_t;cdecl;
  mono_declsec_flags_from_class : function(klass:PMonoClass):uint32_t;cdecl;
  mono_declsec_flags_from_assembly : function(assembly:PMonoAssembly):uint32_t;cdecl;
  mono_declsec_get_demands : function(callee:PMonoMethod; demands:PMonoDeclSecurityActions):MonoBoolean;cdecl;
  mono_declsec_get_linkdemands : function(callee:PMonoMethod; klass:PMonoDeclSecurityActions; cmethod:PMonoDeclSecurityActions):MonoBoolean;cdecl;
  mono_declsec_get_inheritdemands_class : function(klass:PMonoClass; demands:PMonoDeclSecurityActions):MonoBoolean;cdecl;
  mono_declsec_get_inheritdemands_method : function(callee:PMonoMethod; demands:PMonoDeclSecurityActions):MonoBoolean;cdecl;
  mono_declsec_get_method_action : function(method:PMonoMethod; action:uint32_t; entry:PMonoDeclSecurityEntry):MonoBoolean;cdecl;
  mono_declsec_get_class_action : function(klass:PMonoClass; action:uint32_t; entry:PMonoDeclSecurityEntry):MonoBoolean;cdecl;
  mono_declsec_get_assembly_action : function(assembly:PMonoAssembly; action:uint32_t; entry:PMonoDeclSecurityEntry):MonoBoolean;cdecl;
  mono_reflection_type_get_type : function(reftype:PMonoReflectionType):PMonoType;cdecl;
  mono_reflection_assembly_get_assembly : function(refassembly:PMonoReflectionAssembly):PMonoAssembly;cdecl;
